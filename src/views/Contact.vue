    ...
    <div class="form">
      <div class="contact-info">
        ...
        <div class="social-media">
          ...
          <div class="social-icons">
            <a href="https://twitter.com/sagrawal2418">
              <i class="fab fa-twitter"></i>
            </a>
            <a href="https://github.com/sagrawal2418">
              <i class="fab fa-github"></i>
            </a>
            <a href="https://www.linkedin.com/in/sagrawal2418/">
      ...
      <div class="contact-form">
        ...
        <form class="message-container">
          <h3 class="title">{{ contact_us_title }}</h3>
...
export default {
  data() {
    return {
      ...
      contactInfo: {
        address: '3411 Town Ct S Lawrenceville NJ 08648',
        email: 'sandeepagrawal2418@gmail.com',
        phone: '240-394-2418'
      },
      social_media_title: 'Connect with me :',
